...
// 1. sort() : 오름차순으로 정렬, 원본 수정? 함
console.log('1. sort()');
iveMembers.sort();
console.log(iveMembers)

// 2. reverse() : 역순으로 정렬, 원본 수정? 함
...
//점수에 대해서 오름차순으로 정렬 (점수 높은 값부터)
console.log('점수에 대해서 오름차순으로 정렬')
data.sort((x,y)=>{
  return y.score-x.score;
})
console.log(data)

//점수에 대해서 내림차순으로 정렬(점수 낮은 값부터)
console.log('점수에 대해서 내림차순으로 정렬')
data.sort((x,y)=>{
